...
class TestDisEnaTenantDB(unittest.TestCase):
    def setUp(self):
    ...
    def test01_DisTenDb(self):
        """禁用TenantDB"""
        self.log.info(message="test01_DisTenDb", name="test06_DisEnaTenantDB.py", line=get_run_line())
        # 设置请求数据
    ...
    def test02_DisTenDbFail(self):
        """禁用TenantDB失败：不存在"""
        self.log.info(message="test02_DisTenDbFail", name="test06_DisEnaTenantDB.py", line=get_run_line())
        # 设置请求数据
    ...
    def test03_EnaTenDb(self):
        """启用TenantDB"""
        self.log.info(message="test03_EnaTenDb", name="test06_DisEnaTenantDB.py", line=get_run_line())
        # 设置请求数据
    ...
    def test04_TenDbFail(self):
        """启用TenantDB成功：不存在"""
        self.log.info(message="test04_TenDbFail", name="test06_DisEnaTenantDB.py", line=get_run_line())
        # 设置请求数据
